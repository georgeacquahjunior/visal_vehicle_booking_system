...
import { Bell, BellOff, CheckCheck, CheckCircle2, Clock3, MessageSquareReply, Send, XCircle } from "lucide-react";
    ...
    <div className="text-[#11233f]">
      <section className="relative flex min-h-[160px] flex-col justify-center gap-1 overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-[#eef3ff] p-8">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <InfoButton text="New booking requests, approvals, and declines all land here." />
        </div>
              ...
              {visibleNotifications.map((notification) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-start gap-3.5 p-4 text-left transition-colors hover:bg-slate-50 ${notification.is_read ? "bg-white" : "bg-blue-50/40"}`}
                  >
                    <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${meta.class}`}>
                      <Icon size={18} />
                    </div>
