    ...
    >
      <div className="flex items-center gap-3.5 rounded-[20px] border border-[#e5e7e7] p-[12px_10px]">
        ...
        {!collapsed && (
          <div>
            ...
            <p className="mt-1 text-[13px] tracking-[0.01em] text-slate-600">Vehicle Booking</p>
          </div>
        )}
      </div>
      ...
      <nav className="mt-[30px] flex flex-col gap-2.5">
        <NavLink to="/booking" end className={linkClass}>
          ...
          <span className={labelClass}>New Booking</span>
        </NavLink>
        <NavLink to="/booking/scheduleview" className={linkClass}>
          <CalendarDays size={18} />
          <span className={labelClass}>View Schedule</span>
        </NavLink>
        <NavLink to="/booking/viewbookings" className={linkClass}>
          <ListChecks size={18} />
